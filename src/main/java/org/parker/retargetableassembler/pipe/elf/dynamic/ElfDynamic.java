package org.parker.retargetableassembler.pipe.elf.dynamic;
...
import static org.parker.retargetableassembler.pipe.elf.Elf.FileHeader.*;
    ...
    public String getName(Elf elf, Elf.SectionHeader sectionHeader) throws IOException {
        ...
        switch ((int) d_tag)
        {
            ...
            case DT_GNU_PRELINKED:
                ...
                //if (tmp == NULL)
                //    sb.append ("<corrupt time val: " + atime);
                //else
                sb.append(new SimpleDateFormat("yyyy-MM-dd:hh:mm:ss").format(date));
                //sb.append ("%04u-%02u-%02uT%02u:%02u:%02u\n",

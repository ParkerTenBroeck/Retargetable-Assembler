...
/*
  ...
  File Name: lcalc.jflex
  To Create: > jflex lcalc.jflex
...
/* --------------------------Usercode Section------------------------ */
package org.parker.retargetableassembler.tokenizer.calc.jflex;
   
import java_cup.runtime.*;
import org.parker.retargetableassembler.tokenizer.calc.cup.sym;

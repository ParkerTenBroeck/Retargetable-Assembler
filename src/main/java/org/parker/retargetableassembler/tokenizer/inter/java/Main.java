package org.parker.retargetableassembler.tokenizer.inter.java;/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
import org.parker.retargetableassembler.tokenizer.inter.cup.parser;
import org.parker.retargetableassembler.tokenizer.inter.jflex.Lexer;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if(args.length == 0){
      args = new String[]{"C:\\Users\\parke\\Downloads\\jflex-1.8.2\\jflex-1.8.2\\examples\\cup-interpreter\\src\\test\\data\\example.as"};
    }
